...
test('legalReturn', async ({ page }) => {
  ...
  await expect(page.locator('.multiselect__tags').filter({ hasText: 'АО КASPI.KZ' }).first()).toHaveText('АО КASPI.KZ')
